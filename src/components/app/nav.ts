...
export const appNav: NavItem[] = [
  ...
  { href: "/dashboard/ai-coach", label: "Money Coach", hint: "Spending help", icon: Brain },
  ...
  { href: "/dashboard/subjects", label: "Classes", hint: "Subjects", icon: BookOpen },
  { href: "/dashboard/notes", label: "Notes", hint: "Study notes", icon: NotebookPen },
  { href: "/dashboard/assignments", label: "Homework", hint: "Deadlines", icon: ClipboardList },
  ...
  { href: "/dashboard/progress", label: "Progress", hint: "Attendance & CGPA", icon: TrendingUp },
  { href: "/dashboard/ai-tutor", label: "Study Tutor", hint: "Ask anything", icon: MessageCircle },
  { href: "/dashboard/profile", label: "Profile", hint: "Your details", icon: UserRound },
  { href: "/settings", label: "Settings", hint: "Preferences", icon: Settings },
];
